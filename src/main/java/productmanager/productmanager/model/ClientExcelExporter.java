...
public class ClientExcelExporter {
    ...
    private List<CustomerLogin> clients;

    public ClientExcelExporter(List<CustomerLogin> clients) {
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 0, "Code_Client", style);
        createCell(row, 1, "Nom", style);
        createCell(row, 2, "Email", style);
        createCell(row, 3, "Catégorie", style);
        createCell(row, 4, "Téléphone", style);
    ...
    private void writeDataLines() {
        ...
        for (CustomerLogin client : clients) {
                ...
                createCell(row, columnCount++, client.getCategory(), style);
                createCell(row, columnCount++, client.getPhoneNumber(), style);
